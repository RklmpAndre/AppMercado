...
CREATE TABLE `historico_compras` (
  ...
  `pedido_entrega` int DEFAULT NULL,
  `tipo_entrega` int DEFAULT NULL,
  `total_compra` double DEFAULT NULL,
  `produtos` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `historico_compras_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuários` (`cpf`)
...
INSERT INTO `item_carrinho` VALUES (4,18,1),(4,20,1),(5,18,2),(5,19,2),(5,20,2),(5,21,2),(5,22,2);
...
-- Dump completed on 2023-11-02 23:51:32
